...
ncols, nrows = 2,2
f, axe= plt.subplots(ncols=ncols,nrows=nrows,figsize=(26,15), gridspec_kw={"width_ratios":1*np.ones(ncols), "height_ratios":1*np.ones(nrows)}, layout='constrained')
...
axe[1,1].axvline(x = 1.6434, color = 'black', linestyle='dashed', linewidth=4.5, zorder=2000)
axe[1,1].text(1.68, 0.7, r'$v_{\rm CM} \ \approx \ 44 km/s $' , fontsize=14, verticalalignment='bottom', rotation=90, zorder=2000)

axe[0,1].axvline(x = 1.6434, color = 'black', linestyle='dashed', linewidth=4.5, zorder=2000)
axe[0,1].text(1.55, 0.45, r'$v_{\rm CM} \ \approx \ 44 km/s $' , fontsize=14, verticalalignment='bottom', rotation=90, zorder=2000)

axe[0,0].axvline(x = 0, color = 'black', linestyle='dashed', zorder=2000, linewidth=4.5)
axe[0,0].axvline(x = -2, color = 'black', linestyle='dashed', zorder=2000, linewidth=4.5)

axe[0,0].text(0.1, 0.08, r'$t_{\rm merge} \ \approx \ 1 Gyr $' , fontsize=14, verticalalignment='bottom', rotation=90, zorder=2000)
axe[0,0].text(-2.22, 0.3, r'$t_{\rm merge} \ \approx \ 10 Myr $' , fontsize=14, verticalalignment='bottom', rotation=90, zorder=2000)


axe[1,0].axvline(x = 0, color = 'black', linestyle='dashed', zorder=2000, linewidth=4.5)
axe[1,0].axvline(x = -2, color = 'black', linestyle='dashed', zorder=2000, linewidth=4.5)

axe[1,0].text(0.1, 0.1, r'$t_{\rm merge} \ \approx \ 1 Gyr $' , fontsize=14, verticalalignment='bottom', rotation=90, zorder=2000)
axe[1,0].text(-1.92, 0.45, r'$t_{\rm merge} \ \approx \ 10 Myr $' , fontsize=14, verticalalignment='bottom', rotation=90, zorder=2000)
...
layoutAxesNoXlabel(ax=axe[0,0], nameY=nameY, fontsize=20, setMinor=False, labelpad=13)
layoutAxes(ax=axe[1,0], nameX=nameX, nameY=nameY, fontsize=20, setMinor=False)

layoutAxesNoXlabel(ax=axe[0,1], nameY=nameY, fontsize=20, setMinor=False, labelpad=13)
...
plt.savefig('./CDF_general_test_4.png', bbox_inches='tight', dpi = 600)
