...
ncols, nrows = 2,2
f, axe= plt.subplots(ncols=ncols,nrows=nrows,figsize=(20, 15), gridspec_kw={"width_ratios":1*np.ones(ncols), "height_ratios":1*np.ones(nrows)}, layout='constrained', sharex='row', sharey='row')
...
axe[0,0].legend(loc='lower left', fontsize = '22', markerscale=4, edgecolor='white')
...
nameY = r'$\log_{{\rm{10}}}(t_{\rm merge})$$[\rm{Myr}]$'
"""
axe[0,0].text(1.67, -9, r'$v_{\rm CM} \ \approx \ 44 km/s $' , fontsize=18, rotation=90, verticalalignment='bottom')
axe[0,0].text(1.44, -9, r'$v_{\rm CM} \ \approx \ 26 km/s $' , fontsize=18, rotation=90, verticalalignment='bottom')
axe[0,0].text(-0.35, 3.75, r'$t_{\rm merge} \ \approx \ 1 Gyr $' , fontsize=18, verticalalignment='top')
axe[0,0].text(1.676, 0.2, r'$v_{\rm CM} \times t_{\rm merge} < R_{\rm VIR} \times \epsilon $' , fontsize=18, rotation=-8, verticalalignment='bottom')
axe[0,0].text(1.68, -1.5, r'$v_{\rm CM} \times t_{\rm merge} < r_{\rm VIR} \times \epsilon $' , fontsize=18, rotation=-8, verticalalignment='bottom')
...
axe[0,0].text(1.67, -9, r'$v_{\rm CM} \ \approx \ 44 km/s $' , fontsize=18, rotation=90, verticalalignment='bottom')
axe[0,0].text(1.44, -9, r'$v_{\rm CM} \ \approx \ 26 km/s $' , fontsize=18, rotation=90, verticalalignment='bottom')
axe[0,0].text(-0.3, 3.75, r'$t_{\rm merge} \ \approx \ 1 \rm{Gyr} $' , fontsize=18, verticalalignment='top')
axe[0,0].text(1.75, 0.05, r'$v_{\rm CM} \times t_{\rm merge} < R_{\rm VIR} \times \epsilon $' , fontsize=18, rotation=-10.5, verticalalignment='bottom')
axe[0,0].text(1.75, -1.38, r'$v_{\rm CM} \times t_{\rm merge} < r_{\rm VIR} \times \epsilon $' , fontsize=18, rotation=-10.5, verticalalignment='bottom')
...
#axe[1,0].legend(loc='upper right', fontsize = '22', markerscale=4, edgecolor='white')
...
axe[0,1].legend(loc='lower left', fontsize = '22', markerscale=4, edgecolor='white')
...
axe[0,1].text(1.44, -9, r'$v_{\rm CM} \ \approx \ 26 km/s $' , fontsize=18, rotation=90, verticalalignment='bottom')
axe[0,1].text(-0.3, 3.75, r'$t_{\rm merge} \ \approx \ 1 \rm{Gyr} $' , fontsize=18, verticalalignment='top')
...
axe[0,1].text(1.75, -1.38, r'$v_{\rm CM} \times t_{\rm merge} < r_{\rm VIR} \times \epsilon $' , fontsize=18, rotation=-10.5, verticalalignment='bottom')
...
#axe[1,1].legend(loc='upper right', fontsize = '22', markerscale=4, edgecolor='white')
...
layoutAxes(ax=axe[1,1], nameX=nameX_1, nameY=nameY_1, setMinor=True, labelpad=12)

strr_2 = r"$t_{\rm{inspiral}}=1\,\rm{Gyr}$"
x_xy_2, y_xy_2 = 0.44, 0.62 #0.48, 0.6
x_xytext_2, y_xytext_2 = 0.79, 0.73
conn_2 = "arc3,rad=-0.2"
...
x_xy_3, y_xy_3 = 0.35, 0.55 #0.31,0.7
x_xytext_3, y_xytext_3 = 0.2, 0.75
conn_3 = "arc3,rad=+0.2"
...
axe[0,1].tick_params(labelleft=True)
axe[1,1].tick_params(labelleft=True)

plt.savefig('./ResearchFig1_test3.2.png', bbox_inches='tight', dpi = 600)
