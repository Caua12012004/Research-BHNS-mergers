...
print(f"Model A: {A_max_rate}")
#print(f"Model A: {}")
print(f"Model B: {B_min_rate}")
#print(f"Model B: {}")
...
mask_data_max_BNS = [mask_A, mask_B, mask_C, mask_D, mask_F, mask_G, mask_H, mask_I, mask_J, mask_K, mask_L, mask_M, mask_N, mask_O, mask_P, mask_Q, mask_R, mask_S, mask_T]

mask_A = data.mask_A_min
mask_B = data.mask_B_min
mask_C = data.mask_C_min
mask_D = data.mask_D_min
mask_F = data.mask_F_min
mask_G = data.mask_G_min
mask_H = data.mask_H_min
mask_I = data.mask_I_min
mask_J = data.mask_J_min
mask_K = data.mask_K_min
mask_L = data.mask_L_min
mask_M = data.mask_M_min
mask_N = data.mask_N_min
mask_O = data.mask_O_min
mask_P = data.mask_P_min
mask_Q = data.mask_Q_min
mask_R = data.mask_R_min
mask_S = data.mask_S_min
mask_T = data.mask_T_min

mask_data_min_BNS = [mask_A, mask_B, mask_C, mask_D, mask_F, mask_G, mask_H, mask_I, mask_J, mask_K, mask_L, mask_M, mask_N, mask_O, mask_P, mask_Q, mask_R, mask_S, mask_T]
