...
class MSSFR(object):
    ...
    def returnFractionMZ_GSMF(self, Zlower, Zupper, redshift):
        ...
        if self.ZMprescription == 'Ma et al. (2015)':
            ...
            Mlower = 10**self.Savaglio2005ZM(Zlower_Zsun, z)
             ...
             raise ValueError("The mass-metallicity prescription is not recognised.\n"+\
                              ...
                              "Ma et al. (2015), Langer et al. (2006),"+\
                              "Langer et al. +offset (2006)\n"+\
    ...
    def returnMSSFR(self, lowerBinNr=None, agesBirth=None, redshiftBirth=None):
        ...
        lowerBinNr=None, 
        agesBirth=None,  # are the times at which the binaries are born
        redshiftBirth=None # are the redshifts at which the binaries are born
