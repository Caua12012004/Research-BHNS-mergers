...
ncols, nrows = 2,2
#25 - 28.75
f, axe= plt.subplots(ncols=ncols,nrows=nrows,figsize=(25, 18.75), gridspec_kw={"width_ratios":1*np.ones(ncols), "height_ratios":1*np.ones(nrows)}, layout='constrained', sharex='row', sharey='row')
...
axe[0,0].legend(loc='lower left', fontsize = 35, markerscale=3)

axe[0,0].axvline(x=1.6434, ymin=0, ymax=1, color="black", lw=4, linestyle=':', zorder=2000)
axe[0,0].axvline(x=1.4150, ymin=0, ymax=1, color="black", lw=4, linestyle=':', zorder=2000)
...
# axe[0,0].text(1.67, -12.5, r'$v_{\rm CM} \ \approx \ 44 km/s $' , fontsize=25, rotation=90, verticalalignment='bottom')
# axe[0,0].text(1.44, -12.5, r'$v_{\rm CM} \ \approx \ 26 km/s $' , fontsize=25, rotation=90, verticalalignment='bottom')
# axe[0,0].text(-0.35, 3.75, r'$t_{\rm merge} \ \approx \ 1 Gyr $' , fontsize=25, verticalalignment='top')
# axe[0,0].text(1.676, 0.2, r'$v_{\rm CM} \times t_{\rm merge} < R_{\rm VIR} \times \epsilon $' , fontsize=16.5, rotation=-8, verticalalignment='bottom')
# axe[0,0].text(1.68, -1.5, r'$v_{\rm CM} \times t_{\rm merge} < r_{\rm VIR} \times \epsilon $' , fontsize=16.5, rotation=-8, verticalalignment='bottom')

axe[0,0].text(1.67, -9, r'$v_{\rm CM} \ \approx \ 44 km/s $' , fontsize=25, rotation=90, verticalalignment='bottom')
axe[0,0].text(1.44, -9, r'$v_{\rm CM} \ \approx \ 26 km/s $' , fontsize=25, rotation=90, verticalalignment='bottom')
axe[0,0].text(-0.3, 3.75, r'$t_{\rm merge} \ \approx \ 1 Gyr $' , fontsize=25, verticalalignment='top')
axe[0,0].text(1.675, 0.02, r'$v_{\rm CM} \times t_{\rm merge} < R_{\rm VIR} \times \epsilon $' , fontsize=25, rotation=-10.5, verticalalignment='bottom')
axe[0,0].text(1.675, -1.38, r'$v_{\rm CM} \times t_{\rm merge} < r_{\rm VIR} \times \epsilon $' , fontsize=25, rotation=-10.5, verticalalignment='bottom')
...
# model_dt_BHNS_low = 1.3*3.08*(10**16)*0.1/(model_v_sys_for_dt_BHNS*3.154*(10**13))

# axe[0,0].plot(model_v_sys_BHNS, np.log10(model_dt_BHNS), color="black", lw=4, linestyle=':', zorder=2000)
# axe[0,0].plot(model_v_sys_BHNS, np.log10(model_dt_BHNS_low), color="black", lw=4, linestyle=':', zorder=2000)
...
model_dt_low = 1.3*3.08*(10**16)*0.1/(model_v_sys_for_dt*3.154*(10**13))

axe[0,0].plot(model_v_sys, np.log10(model_dt), color="black", lw=4, linestyle=':', zorder=2000)
axe[0,0].plot(model_v_sys, np.log10(model_dt_low), color="black", lw=4, linestyle=':', zorder=2000)
...
layoutAxes(ax=axe[0,0], nameX=nameX, nameY=nameY, fontsize=30, setMinor=True, labelpad=12)
...
axe[1,0].legend(loc='lower right', fontsize = 35, markerscale=3)
...
x_xytext_1, y_xytext_1 = 0.82, 0.73 #0.7
conn_1 = "arc3,rad=-0.2"
...
layoutAxes(ax=axe[1,0], nameX=nameX_1, nameY=nameY_1, fontsize=30, setMinor=True, labelpad=12)
...
axe[0,1].legend(loc='lower left', fontsize = 35, markerscale=3)

axe[0,1].axvline(x=1.6434, ymin=0, ymax=1, color="black", lw=4, linestyle=':', zorder=2000)
axe[0,1].axvline(x=1.4150, ymin=0, ymax=1, color="black", lw=4, linestyle=':', zorder=2000)
...
axe[0,1].text(1.67, -9, r'$v_{\rm CM} \ \approx \ 44 km/s $' , fontsize=25, rotation=90, verticalalignment='bottom')
axe[0,1].text(1.44, -9, r'$v_{\rm CM} \ \approx \ 26 km/s $' , fontsize=25, rotation=90, verticalalignment='bottom')
axe[0,1].text(-0.3, 3.75, r'$t_{\rm merge} \ \approx \ 1 Gyr $' , fontsize=25, verticalalignment='top')
axe[0,1].text(1.675, 0.02, r'$v_{\rm CM} \times t_{\rm merge} < R_{\rm VIR} \times \epsilon $' , fontsize=25, rotation=-10.5, verticalalignment='bottom')
axe[0,1].text(1.675, -1.38, r'$v_{\rm CM} \times t_{\rm merge} < r_{\rm VIR} \times \epsilon $' , fontsize=25, rotation=-10.5, verticalalignment='bottom')
...
axe[0,1].plot(model_v_sys, np.log10(model_dt_low), color="black", lw=4, linestyle=':', zorder=2000)
...
layoutAxes(ax=axe[0,1], nameX=nameX, nameY=nameY, fontsize=30, setMinor=True, labelpad=12)
...
axe[1,1].legend(loc='lower right', fontsize = 35, markerscale=3)
...
layoutAxes(ax=axe[1,1], nameX=nameX_1, nameY=nameY_1, fontsize=30, setMinor=True, labelpad=12)

strr_2 = r"$t_{\rm{inspiral}}=1\,\rm{Gyr}$"
x_xy_2, y_xy_2 = 0.44, 0.62 #0.415, 0.62
x_xytext_2, y_xytext_2 = 0.79, 0.76 #0.765
conn_2 = "arc3,rad=-0.2"
...
x_xy_3, y_xy_3 = 0.35, 0.55 #0.32,0.7
x_xytext_3, y_xytext_3 = 0.20, 0.75
conn_3 = "arc3,rad=+0.2"
...
plt.savefig('./ResearchFig1_test3.3.pdf', bbox_inches='tight', dpi = 600)
